...
\logoinstituicao{2.5cm}{figuras/principal_ufmg.jpg}
...
\preambulo{{\imprimirprojeto} apresentado ao Curso de Engenharia Aeroespacial da Universidade Federal de Minas Gerais, como requisito parcial para a obtenção do título de {\imprimirtituloAcademico} em Engenharia Aeroespacial.}
